...
class Plot:
    def __init__(self, title: str = None):
        ...
        self.transpose_theme = dict(
            layout=go.Layout(
                ...
                title_x=0.14,
                title=title
                + '<br><sup><i style="font-size: 35px;">Powered by <span style="color: #ff5e48">@TransposeData</span></i></sup>',
    ...
    def add_data(
        self, data: dict, type: str = "line", shape: str = "linear", smoothing: int = 1
    ) -> None:
        """
        ...
        try:
            ...
            ) or (isinstance(data["x"][0], str) and data["x"][0].isnumeric()):
            ...
            ) or (isinstance(data["y"][0], str) and data["y"][0].isnumeric()):
    ...
    def show(self) -> None:
        ...
        if len(self.data) == 0:
            raise PlotError("No data to show.")
    ...
    def render(self, path: str, format: str = "png") -> None:
        ...
        if len(self.data) == 0:
            raise PlotError("No data to render.")
