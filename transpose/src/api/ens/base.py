...
class ENS():
    ...
    def records_by_name(self, ens_names: str or list = None,) -> str:
        return self.super.perform_authorized_request(self, _records_by_name(ens_names=ens_names))
    
    # Get ENS Records by ENS Node
    # https://docs.transpose.io/reference/get_ens-records-by-node
    def records_by_node(self, ens_nodes: str or list = None,) -> str:
        return self.super.perform_authorized_request(self, _records_by_node(ens_nodes=ens_nodes))

    # Get ENS Records by ENS Token ID
    # https://docs.transpose.io/reference/get_ens-records-by-token-id
    def records_by_token_id(self, token_ids: int or list = None,) -> str:
        return self.super.perform_authorized_request(self, _records_by_token_id(token_ids=token_ids))
    ...
    def transfers_by_name(self,
                              ...
                              order: str='asc',
                              limit: int=10) -> str:
        return self.super.perform_authorized_request(self, _transfers_by_name(ens_name=ens_name, transferred_after=transferred_after, transferred_before=transferred_before, transfer_category=transfer_category, order=order, limit=limit))
    ...
    def transfers_by_node(self,
                              ...
                              order: str='asc',
                              limit: int=10) -> str:
        return self.super.perform_authorized_request(self, _transfers_by_node(node=node, transferred_after=transferred_after, transferred_before=transferred_before, transfer_category=transfer_category, order=order, limit=limit))
    ...
    def transfers_by_token_id(self,
                              ...
                              order: str='asc',
                              limit: int=10) -> str:
        return self.super.perform_authorized_request(self, _transfers_by_token_id(token_id=token_id, transferred_after=transferred_after, transferred_before=transferred_before, transfer_category=transfer_category, order=order, limit=limit))
