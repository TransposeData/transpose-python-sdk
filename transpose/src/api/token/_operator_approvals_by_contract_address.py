...
def _operator_approvals_by_contract_address(contract_address: str = None,
    ...
    base_url = '{}?contract_address={}&approved_after={}&approved_before={}&order={}&limit={}'.format(TOKEN_API_ENDPOINTS['operator_approvals_by_contract_address'], contract_address, approved_after, approved_before, order, limit)
