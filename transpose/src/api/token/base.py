...
class Token:
    ...
    def tokens_by_contract_address(
        ...
        return self.super.perform_authorized_request(
            TokenModel, _tokens_by_contract_address(contract_addresses)
        )
    ...
    def tokens_by_name(
        ...
        return self.super.perform_authorized_request(
            TokenModel, _tokens_by_name(name, limit, fuzzy)
        )

    # Get Tokens by Symbol
    # https://api.transpose.io/v0/token/tokens-by-symbol
    def tokens_by_symbol(
        self, symbol: str = None, limit: int = 10, fuzzy: bool = False
    ) -> List[TokenModel]:
        return self.super.perform_authorized_request(
            TokenModel, _tokens_by_symbol(symbol, limit, fuzzy)
        )
    ...
    def tokens_by_owner(
        ...
        return self.super.perform_authorized_request(
            TokenWithOwner, _tokens_by_owner(owner_address, contract_address, limit)
        )
    ...
    def owners_by_contract_address(
        ...
        return self.super.perform_authorized_request(
            TokenOwner, _owners_by_contract_address(contract_address, limit)
        )
    ...
    def transfers(
        ...
        return self.super.perform_authorized_request(
            TokenTransfer,
            _transfers(transferred_after, transferred_before, order, limit),
        )
    ...
    def native_token_transfers(
        self,
        transferred_after: int or str = "1970-01-01T00:00:00",
        transferred_before: int or str = "2050-01-01T00:00:00",
        order: str = "asc",
        limit: int = 10,
    ) -> List[NativeTokenTransfer]:
        return self.super.perform_authorized_request(
            NativeTokenTransfer,
            _native_token_transfers(
                transferred_after, transferred_before, order, limit
            ),
        )

    # Get Native Token Transfers by Address
    # https://api.transpose.io/v0/token/native-token-transfers-by-address
    def native_token_transfers_by_account(
        self,
        account_address: str = None,
        transferred_after: int or str = "1970-01-01T00:00:00",
        transferred_before: int or str = "2050-01-01T00:00:00",
        ...
        return self.super.perform_authorized_request(
            NativeTokenTransfer,
            _native_token_transfers_by_account(
                account_address,
                transferred_after,
                transferred_before,
                transfer_direction,
    ...
    def native_token_balances_by_account(
        self, account_addresses: list or str = None
    ) -> List[NativeTokenBalance]:
        return self.super.perform_authorized_request(
            NativeTokenBalance, _native_token_balances_by_account(account_addresses)
        )
    ...
    def swaps(
        ...
        return self.super.perform_authorized_request(
            Swap, _swaps(occurred_after, occurred_before, order, limit)
        )

    # Get Swaps by Account
    # https://api.transpose.io/v0/token/swaps-by-account
    def swaps_by_account(
        self,
        account_address: str = None,
        occurred_after: int or str = "1970-01-01T00:00:00",
        occurred_before: int or str = "2050-01-01T00:00:00",
        ...
        return self.super.perform_authorized_request(
            Swap,
            _swaps_by_account(
                account_address, occurred_after, occurred_before, order, limit
            ),
        )

    # Get Swaps by Contract Address
    # https://api.transpose.io/v0/token/swaps-by-contract-address
    def swaps_by_contract_address(
        self,
        contract_address: str = None,
        direction: str = "all",
        occurred_after: int or str = "1970-01-01T00:00:00",
    ...
    def swaps_by_pair(
        ...
        return self.super.perform_authorized_request(
            Swap,
            _swaps_by_pair(
                token_one, token_two, occurred_after, occurred_before, order, limit
            ),
        )
