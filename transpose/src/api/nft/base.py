...
class NFT:
    ...
    def collections_by_date_created(
        self,
        ...
        return self.super.perform_authorized_request(
            Collection,
            _collections_by_date_created(
                created_after, created_before, standard, order, limit
            ),
        )

    # Get Collections by Contract Address
    # https://api.transpose.io/v0/nft/collections-by-contract-address
    def collections_by_contract_address(
        self, contract_addresses: str or list = None
    ) -> List[Collection]:
        return self.super.perform_authorized_request(
            Collection, _collections_by_contract_address(contract_addresses)
        )

    # Get Collections by Name
    # https://api.transpose.io/v0/nft/collections-by-name
    def collections_by_name(
        self, name: str = None, limit: int = 10, fuzzy: bool = False
    ) -> List[Collection]:
        return self.super.perform_authorized_request(
            Collection, _collections_by_name(name, limit, fuzzy)
        )

    # Get Collections by Synbol
    # https://api.transpose.io/v0/nft/collections-by-symbol
    def collections_by_symbol(
        self, symbol: str = None, limit: int = 10, fuzzy: bool = False
    ) -> List[Collection]:
        return self.super.perform_authorized_request(
            Collection, _collections_by_symbol(symbol, limit, fuzzy)
        )

    # Get NFTs by Date Minted
    # https://api.transpose.io/v0/nft/nfts-by-date-minted
    def nfts_by_date_minted(
        self,
        ...
        return self.super.perform_authorized_request(
            NFTModel,
            _nfts_by_date_minted(
                minted_after, minted_before, contract_address, order, limit
            ),
        )

    # Get NFTs by Contract Address
    # https://api.transpose.io/v0/nft/nfts-by-contract-address
    def nfts_by_contract_address(
        self, contract_address: str = None, limit: int = 10
    ) -> List[NFTModel]:
        return self.super.perform_authorized_request(
            NFTModel, _nfts_by_contract_address(contract_address, limit)
        )

    # Get NFTs by Token ID
    # https://api.transpose.io/v0/nft/nfts-by-token-id
    def nfts_by_token_id(
        self, contract_addresses: str or list = None, token_ids: str or int = None
    ) -> List[NFTModel]:
        return self.super.perform_authorized_request(
            NFTModel, _nfts_by_token_id(contract_addresses, token_ids)
        )
    ...
    def nfts_by_name(
        ...
        return self.super.perform_authorized_request(
            NFTModel, _nfts_by_name(name, limit, fuzzy)
        )

    # Get NFTs by Owner
    # https://api.transpose.io/v0/nft/nfts-by-owner
    def nfts_by_owner(
        self, owner_address: str = None, contract_address: str = None, limit: int = 10
    ) -> List[NFTWithOwner]:
        return self.super.perform_authorized_request(
            NFTWithOwner, _nfts_by_owner(owner_address, contract_address, limit)
        )

    # Get Owners by Contract Address
    # https://api.transpose.io/v0/nft/owners-by-contract-address
    def owners_by_contract_address(
        self, contract_address: str = None, limit: int = 10
    ) -> List[NFTOwner]:
        return self.super.perform_authorized_request(
            NFTOwner, _owners_by_contract_address(contract_address, limit)
        )

    # Get Owners by Token ID
    # https://api.transpose.io/v0/nft/owners-by-token-id
    def owners_by_token_id(
        self, contract_address: str = None, token_id: str or int = None, limit: int = 10
    ) -> List[NFTOwner]:
        return self.super.perform_authorized_request(
            NFTOwner, _owners_by_token_id(contract_address, token_id, limit)
        )
    ...
    def transfers(
        ...
        return self.super.perform_authorized_request(
            NFTTransfer, _transfers(transferred_after, transferred_before, order, limit)
        )

    # Get Transfers by Contract Address
    # https://api.transpose.io/v0/nft/transfers-by-contract-address
    def transfers_by_contract_address(
        self,
        contract_address: str = None,
        transferred_after: int or str = "1970-01-01T00:00:00",
        transferred_before: int or str = "2050-01-01T00:00:00",
        ...
        return self.super.perform_authorized_request(
            NFTTransfer,
            _transfers_by_contract_address(
                contract_address, transferred_after, transferred_before, order, limit
            ),
        )

    # Get Transfers by Token ID
    # https://api.transpose.io/v0/nft/transfers-by-token-id
    def transfers_by_token_id(
        self,
        token_id: int = None,
        contract_address: str = None,
        transferred_after: int or str = "1970-01-01T00:00:00",
    ...
    def transfers_by_account(
        ...
        return self.super.perform_authorized_request(
            NFTTransfer,
            _transfers_by_account(
                account_address, transferred_after, transferred_before, order, limit
            ),
        )
    ...
    def sales_by_contract_address(
        ...
        return self.super.perform_authorized_request(
            NFTSale,
            _sales_by_contract_address(
                contract_address, sold_after, sold_before, order, limit
            ),
        )

    # Get Sales by Token ID
    # https://api.transpose.io/v0/nft/sales_by_token_id
    def sales_by_token_id(
        self,
        contract_address: str = None,
        token_id: int = None,
        sold_after: str or int = "1970-01-01T00:00:00",
        ...
        return self.super.perform_authorized_request(
            NFTSale,
            _sales_by_token_id(
                contract_address, token_id, sold_after, sold_before, order, limit
            ),
        )

    # Get Sales by Account Address
    # https://api.transpose.io/v0/nft/sales_by_account
    def sales_by_account(
        self,
        account_address: str = None,
        sold_after: str or int = "1970-01-01T00:00:00",
        sold_before: str or int = "2050-01-01T00:00:00",
        ...
        return self.super.perform_authorized_request(
            NFTSale,
            _sales_by_account(
                account_address, sold_after, sold_before, role, order, limit
            ),
        )
