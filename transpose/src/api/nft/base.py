...
class NFT():
    ...
    # https://api.transpose.io/nft/collections-by-date-created
    ...
    # https://api.transpose.io/nft/collections-by-name
    ...
    # https://api.transpose.io/nft/collections-by-symbol
    ...
    # https://api.transpose.io/nft/nfts-by-date-minted
    ...
    # https://api.transpose.io/nft/nfts-by-token-id
    ...
    # Get NFTs by Name
    # https://api.transpose.io/nft/nfts-by-name
    ...
    # https://api.transpose.io/nft/owners-by-contract-address
    ...
    # https://api.transpose.io/nft/owners-by-token-id
    ...
    # Get Transfers
    # https://api.transpose.io/nft/transfers
    def transfers(self,
    ...
    # https://api.transpose.io/nft/transfers-by-token-id
    ...
    # https://api.transpose.io/nft/transfers-by-account
    ...
    # Get Sales
    # https://api.transpose.io/nft/sales
    def sales(self,
    ...
    # https://api.transpose.io/nft/sales_by_contract_address
    ...
    # https://api.transpose.io/nft/sales_by_account
