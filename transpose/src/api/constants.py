ENS_API_ENDPOINTS = {
    ...
    "records_by_account": "https://api.transpose.io/v0/ens/ens-records-by-resolved-account",
...
TOKEN_API_ENDPOINTS = {
    ...
    "historical_native_token_balance_by_account": "https://api.transpose.io/v0/token/historical-native-token-balance-by-account",
    "historical_token_balances_by_account": "https://api.transpose.io/v0/token/historical-token-balances-by-account",
    "historical_token_owners": "https://api.transpose.io/v0/token/historical-token-owners",
}
