...
ENS_API_ENDPOINTS = {
    ...
    'records_by_account':                     'https://api.transpose.io/ens/ens-records-by-resolved-account',
...
TOKEN_API_ENDPOINTS = {
    ...
    'swaps_by_contract_address':              'https://api.transpose.io/token/swaps-by-contract-address',
